# Uses: where can Sigrid help me in my role? - Portfolio level
Sigrid is aimed at organizational roles that deal with concerns around system health, code quality and their business consequences. This section describes typical uses and analysis questions on portfolio level. 

For portfolio-level uses, see [uses-portfolio](../getting-started/uses-portfolio.md).
