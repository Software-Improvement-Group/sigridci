...
| `aspx`                        | ASP.NET                                | Maintainability, Architecture, Security [(12)](#notes), Static AI        |
...
| `jsp`                         | JSP                                    | Maintainability, Architecture, Security [(12)](#notes), Static AI        |
...
| `perl`                        | Perl                                   | Maintainability, Architecture, Security [(12)](#notes), GenAI            |
...
| `vb`                          | Visual Basic                           | Maintainability, Architecture, Security [(12)](#notes), Static AI, GenAI |
| `vbnet`                       | Visual Basic .NET                      | Maintainability, Architecture, Security [(12)](#notes), Static AI, GenAI |
...
12. Requires an additional *Sigrid Security Checkmarx* license.
