...
- You need to support and manage a Postgres database service.
  ...
  - Sigrid requires PostgreSQL, including some well-known PostgreSQL extensions. Sigrid only uses extensions that Amazon supports on RDS (see [list](https://docs.aws.amazon.com/AmazonRDS/latest/PostgreSQLReleaseNotes/postgresql-extensions.html)). 
