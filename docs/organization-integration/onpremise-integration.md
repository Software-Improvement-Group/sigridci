...
The Docker containers that form Sigrid On-Premise are distributed via [AWS ECR registry](https://571600876202.dkr.ecr.eu-central-1.amazonaws.com/). You will receive an account that allows you to access the container registry. 
