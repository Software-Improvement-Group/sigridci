...
- You need to allow outbound connections to pull the latest Sigrid container images from [AWS ECR registry](571600876202.dkr.ecr.eu-central-1.amazonaws.com).
