...
- Functional Differences:
  ...
  - Documentation and Academy Links: The documentation and academy links in the Sigrid user interface are configurable per deployment, so they can point to an internally mirrored documentation site or be hidden entirely in air-gapped environments. See the [installation runbook](runbook-onpremise-installation.md#sigrid-api) for the Helm configuration.
