...
urgent than those other aspects. Obviously, you shoud still manage those other aspects, as explained in our
...
the system. For example, you can decide to prevent high or critical severity vulnerabilities in public-facing 
