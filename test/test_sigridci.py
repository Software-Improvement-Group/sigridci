...
class SigridCiTest(unittest.TestCase):
    ...
    def testNormalModeOnlyRequiresOverallRatingToMeetTarget(self):
        report = Report()
        self.assertFalse(report.isOverallPassed({"newCodeRatings" : {"MAINTAINABILITY" : 3, "DUPLICATION" : 2}}, 3.5))
        self.assertTrue(report.isOverallPassed({"newCodeRatings" : {"MAINTAINABILITY" : 4, "DUPLICATION" : 2}}, 3.5))
        self.assertTrue(report.isOverallPassed({"newCodeRatings" : {"DUPLICATION" : 2}}, 3.5))
